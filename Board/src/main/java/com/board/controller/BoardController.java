...
public class BoardController extends UiUtils {
    ...
    public String openBoardWrite(@ModelAttribute("params") BoardDTO params, @RequestParam(value = "postNumber", required = false) Long postNumber, Model model) {
        ...
        String test = "모델.어트리뷰트 이동 테스트변수";
                model.addAttribute("lll", test);
    ...
    public String openBoardDetail(@ModelAttribute("params") BoardDTO params, @RequestParam(value = "postNumber", required = false) Long postNumber, Model model) {
        if (postNumber == null) {
    ...
    public String deleteBoard(@ModelAttribute("params") BoardDTO params, @RequestParam(value = "postNumber", required = false) Long postNumber, Model model) {
        if (postNumber == null) {
            return showMessageWithRedirect("올바르지 않은 접근입니다.", "/board/list.do", Method.GET, null, model);
        }
